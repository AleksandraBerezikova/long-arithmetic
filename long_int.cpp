...
LongInt &LongInt::operator-=(LongInt const &second_number)
{
    ...
    else 
    {
        ...
        else
        {
            ...
            {
                sub = int(this->digits[length_first_number]) - second_number.digits[length_second_number] - carry;
                if (sub < 0)
                {
                    carry = 1;
                    sub = sub + 10;
            ...
            this->digits = std::vector<char>(sub_result.begin() + leading_zeros, sub_result.end());
...
std::vector<char> LongInt::add_vectors(std::vector<char> const &digits1, std::vector<char> const &digits2)
{
